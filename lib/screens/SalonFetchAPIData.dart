...
import '../presentation/viewmodels/salon/salon_view_model.dart';
...
class _SalonFetchAPIDataState extends State<SalonFetchAPIData> {
  ...
  void didChangeDependencies() {
    ...
    // Load salon data using ViewModel
    context.read<SalonViewModel>().loadSalonDetails(_salonId.toString());
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<SalonViewModel>(
      builder: (context, viewModel, child) {
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () => viewModel.loadSalonDetails(_salonId.toString()),
          ...
          body: viewModel.isLoading
              ...
              : viewModel.isError
                  ...
                  : viewModel.salonData == null
                      ? _buildNoDataView(viewModel)
                      : _buildSalonContent(viewModel),
        );
      },
    );
  }

  Widget _buildErrorView(SalonViewModel viewModel) {
    return Center(
      child: Column(
  ...
  Widget _buildNoDataView(SalonViewModel viewModel) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
  ...
  Widget _buildSalonContent(SalonViewModel viewModel) {
    final salonData = viewModel.salonData!;
                      ...
                      // Staff (type: 4)
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            title: Text(item.name ?? 'N/A'),
                            subtitle:
                                Text('Experience: ${item.experience ?? 'N/A'}'),
